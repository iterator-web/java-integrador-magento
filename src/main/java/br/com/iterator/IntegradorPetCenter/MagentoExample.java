...
public class MagentoExample {
	...
	static final String MAGENTO_REST_API_URL = "http://192.168.106.128/magentoPetCenter/api/rest";
	static final String MAGENTO_ADMIN_USER = "ricardo";
	static final String MAGENTO_ADMIN_PASS = "123a45b67c";

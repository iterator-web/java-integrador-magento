...
public class HtmlUnit {
	...
	public static void main(String[] args) {
		...
		HtmlPage page1;
		try {
			page1 = webClient.getPage("http://127.0.0.1/magentoPetCenter/index.php/admin/oauth_authorize/?oauth_token=8ee487f36018a70ccc72f1b1a1f22f3e");
			...
			textField.setValueAttribute("seu_usuario");
			final HtmlPasswordInput textField2 = form.getInputByName("login[password]");
			textField2.setValueAttribute("sua_senha");
